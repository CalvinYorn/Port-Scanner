...
import nmap
# import the ipaddress module. we want to use the ipaddress.ip_address(address)
# method to see if we can check for a valid ip address to test.
import ipaddress
# to create regular expressions to ensure that the input is correctly formatted.
import re
